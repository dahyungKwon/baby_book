...
class MemberCommunityScreen extends GetView<MemberCommunityController> {
  MemberCommunityScreen({super.key}) {
    Get.delete<MemberCommunityController>();
    Get.put(MemberCommunityController(postRepository: PostRepository(), memberId: Get.parameters['memberId']!));
  }
  ...
  Widget tabBar(var edgeInsets) {
    return Obx(() => getPaddingWidget(
          ...
          TabBar(
            ...
            labelPadding: const EdgeInsets.fromLTRB(0, 0, 30, 0),
            ...
            labelStyle: const TextStyle(fontSize: 18, fontWeight: FontWeight.w600, overflow: TextOverflow.visible),
            //For Selected tab
