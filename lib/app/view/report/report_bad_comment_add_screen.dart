import 'package:baby_book/app/repository/report_bad_comment_repository.dart';
...
import '../../controller/ReportBadCommentAddController.dart';
import '../../controller/ReportBadPostAddController.dart';

class ReportBadCommentAddScreen extends GetView<ReportBadCommentAddController> {
  FocusNode titleFocusNode = FocusNode();
  FocusNode contentsFocusNode = FocusNode();

  ReportBadCommentAddScreen({super.key}) {
    Get.delete<ReportBadCommentAddController>();
    Get.put(ReportBadCommentAddController(
        reportBadCommentRepository: ReportBadCommentRepository(),
        commentId: Get.parameters['commentId']!,
        commentTitle: Get.parameters['commentTitle']!,
