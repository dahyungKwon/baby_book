...
import '../repository/report_bad_comment_repository.dart';
import '../routes/app_pages.dart';
import '../view/dialog/error_dialog.dart';

class ReportBadCommentAddController extends GetxController {
  final ReportBadCommentRepository reportBadCommentRepository;
  final String commentId;
  final String commentTitle; //당장 노출 안하는중
  ...
  ReportBadCommentAddController(
      {required this.reportBadCommentRepository,
      required this.commentId,
      required this.commentTitle,
      required this.writerName}) {
    assert(reportBadCommentRepository != null);
  ...
  void requestAdd() async {
    ...
    try {
      if (modifyMode) {
        ModelReportBadComment? changed = await ReportBadCommentRepository.put(
            id: modifyReportId!,
            commentId: commentId,
        ...
        ModelReportBadComment? newReport = await ReportBadCommentRepository.add(
            commentId: commentId, title: titleController.text, contents: contentsController.text, memberId: memberId!);
        if (newReport == null) {
          ///네트워크 에러
          return;
        }
  ...
  initModifyMode(int reportId) async {
    ...
    ModelReportBadComment? old = await ReportBadCommentRepository.get(id: reportId);
